...
-- 1. llUA
local UA, BASE = loadstring(http.request({ Url = "https://nekoq-api.vercel.app/ximeax/llUA" }).Body)()
if not UA or not BASE then UA   = "ximeax/software" BASE = "https://nekoq-api.vercel.app/" end
