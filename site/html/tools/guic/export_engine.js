const ExportEngine = {
    generateLua() {
        let code = "--[[ § Generated by MissLua UI Creator Tool (.obj.mlc) § ]]\n\n";
        
        // Сортировка и генерация (твой существующий цикл)
    ...
    showPopup(code) {
        // Формируем чистый HTML документ без лишних функций обработки текста
        const htmlContent = `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
            <div class="header">MissLua UI Creator Tool (.obj.mlct)</div>
            <div class="container">
