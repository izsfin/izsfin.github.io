--[[ Acessoary Editor v1.1.0 | by iME Alt | https://github.com/izsfin/ | License: iMONE 1.0 ]]
...
local titleLabel = label(TitleBar, "Accessory Editor  v1.1.0", 13, Colors.Header, true, UDim2.new(0, 28, 0, 0), UDim2.new(1, -60, 1, 0))
