...
local Loader = loadstring(game:HttpGet("https://izsfin.github.io/ref/luau/DebugConsole/initUI.lua"))()

-- // [1] Table
Loader.setStatus("Loading Executor...")
Loader.setStep(1, "loading")
local ok, Table = pcall(function()
    return loadstring(game:HttpGet("https://izsfin.github.io/ref/luau/DebugConsole/Table.json"))(UID, sUID, nil, BUID)
end)
...
if AccessType == "Special" or AccessType == "Allowed" then
    ...
    DCUrl = meta.verAUID or "https://izsfin.github.io/ref/luau/DebugConsole/Beta/src.lua"
else
    DCUrl = "https://izsfin.github.io/ref/luau/DebugConsole/Stable/src.lua"
end
...
local AntiDC_Milf = loadstring(game:HttpGet("https://izsfin.github.io/ref/luau/DebugConsole/Anti/MD"))()
local sv = AntiDC_Milf and AntiDC_Milf.sv or "v1"
getgenv()["antiDC" .. sv .. "FS"] = AntiDC_Milf
local AntiDC_loader = loadstring(game:HttpGet("https://izsfin.github.io/ref/luau/DebugConsole/Anti/Loader"))()
