...
local function header(p,text,y)
    ...
    h.TextColor3 = Color3.fromRGB(99, 145, 224)
    h.Parent = p
    
    local line = Instance.new("Frame")
    line.Size = UDim2.new(0,60,0,2)
    line.Position = UDim2.new(0,8,0,y+26)
    line.BackgroundColor3 = Color3.fromRGB(36, 67, 120)
...
decalHolder.BackgroundTransparency = 0
decalHolder.BorderSizePixel = 0
decalHolder.Image = assets.NixuC     --- "rbxassetid://73048663385612"
decalHolder.ScaleType = Enum.ScaleType.Fit
decalHolder.Parent = nixu
...
button(cb,"Infinity Yield",488, SCRIPT_MAP["Infinity Yield"])
...
gradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0, Color3.fromRGB(39, 104, 217)), -- 180,120,255 Pink | 39, 104, 217
    ColorSequenceKeypoint.new(1, Color3.fromRGB(2, 61, 163)) -- 120,180,255 Pink | 2, 61, 163 
}
